        ...
        <tr>
          <td style="padding: 32px; color: #374151; font-size: 16px; line-height: 1.6;">
            <div style="margin-bottom: 16px;">
              <span style="background-color: #dbeafe; color: #1e40af; font-size: 12px; font-weight: 700; padding: 6px 14px; border-radius: 20px; text-transform: uppercase; letter-spacing: 0.5px; display: inline-block;">Verify Email</span>
            </div>
            <h2 style="color: #111827; margin-top: 0; font-size: 20px; font-weight: 600;">Welcome to Creatrend!</h2>
            <p style="margin-bottom: 20px; color: #4b5563;">Thank you for registering with <strong>Creatrend</strong>. Please use the verification code below to complete your registration:</p>
            ...
            <div style="background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 20px; text-align: center; margin: 24px 0;">
              <span style="font-family: 'Courier New', Courier, monospace; font-size: 32px; font-weight: 700; color: #0f172a; letter-spacing: 6px; display: inline-block;">${verificationCode}</span>
            </div>
            ...
            <p style="font-size: 14px; color: #94a3b8; margin-bottom: 24px;">
              If you did not attempt to register on Creatrend, you can safely ignore this email.
            </p>
